...
class Search extends React.Component {
    ...
    handleChange(event){
        ...
        if (name === "searchterm") {
            ...
            var show = false ; //conditions to showbox, didnt get it work inside the if??
    ...
    sendSelection = (e) => { //send selection to App through props
        //target value should be the type of meal like breakfast etc
        this.props.selection(this.state.select, this.state.qty, e.target.value)
    }
                ...
                <div className='row'>
                    <div className='col'>
                        <button className='AddButton'
                            onClick={this.sendSelection} value="breakfast" >
                            Add to Breakfast
                        </button>       
                        <button className='AddButton'
                            onClick={this.sendSelection} value="lunch" >
                            Add to Lunch
                        </button>
                        <button className='AddButton'
                            onClick={this.sendSelection} value="dinner" >
                            Add to Dinner
                        </button>      
                        <button className='AddButton'
                            onClick={this.sendSelection} value="snacks" >
                            Add to Snacks
                        </button>
                    </div>                      
                </div>
